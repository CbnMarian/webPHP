    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            ?>
                        ...
                        <hr>
                        <img class="img-responsive" src="../CMS/images/<?php echo $post_image ?>" alt="Project image">
                    ...
                    if (isset($_POST['create_comment'])) {
                        ...
                        if (!empty($comment_post_author) && !empty($comment_email) && !empty($comment_content)) {
                    ...
                    <div class="well">
                        ...
                        <form action="" method="post" role="form">
                            <div class="form-group">
                                ...
                                <input type="text" name="comment_post_author" class="form-control">
                            </div>
                            <div class="form-group">
                    ...
                    ?>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading"><?php echo $comment_post_author; ?>
